...
Original file: https://github.com/boltops-pro/ec2/blob/master/README.md
...
* [awslogs](https://github.com/boltopspro/awslogs): Centralized logging of the Instance logs to CloudWatch Logs.
* [cfn-hup](https://github.com/boltopspro/cfn-hup): Continuous configuration management to automatically update instance.
* [ssm](https://github.com/boltopspro/ssm): Secure ssh and session manager access to the instance.
...
Refer to each configsets README on details for further customization.  For example, you can [customize what logs get sent](https://github.com/boltopspro/awslogs#customize-awslogsconf) to CloudWatch logs.

## Project Configsets

You may want to add additional configsets. Examples:

* [httpd](https://github.com/boltopspro/httpd): Httpd Apache2 Webserver
* [jenkins](https://github.com/boltopspro/jenkins): Jenkins
* [ruby](https://github.com/boltopspro/ruby): Ruby
